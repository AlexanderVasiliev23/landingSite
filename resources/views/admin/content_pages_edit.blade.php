<div class="container-fluid wrapper">
    ...
    <div class="form-group">
        {!! Form::label('name', 'Название страницы:', ['class' => 'col-xs-2 control-label']) !!}
        <div class="col-xs-8">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('alias', $data['alias'], [
                'class'         => 'form-control',
                'placeholder'   => 'Введите псевдоним страницы'
            ]) !!}
        </div>
    </div>

    <div class="form-group">
        {!! Form::label('text', 'Текст страницы:', ['class' => 'col-xs-2 control-label']) !!}
        <div class="col-xs-8">
