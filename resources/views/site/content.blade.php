                ...
                <div class="col-lg-8 wow fadeInLeft delay-06s">
                    <div class="form">
                        <form action="{{ route('home') }}" method="post">
                            ...
                            <input class="input-text" type="text" name="email" value="admin@admin.ru">
                            <textarea class="input-text text-area" name="text" cols="0" rows="0" placeholder="">Your Message *</textarea>
                            ...
                            {{--<input class="input-text" type="text" name="email" value="admin@admin.ru" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;">--}}
